...
parser.add_argument('--hemi_test'   ,default='whole'     ,type=str,   help="loss for difference of left and right brain") # whole, or left or right
...
parser.add_argument('--lr_loss',    default=True        ,type=bool,     help="loss for difference of left and right brain")
